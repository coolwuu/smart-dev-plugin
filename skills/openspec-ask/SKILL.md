...
- `/openspec-ask activity-bar 的 badge 怎麼運作的？`
- `/openspec-ask which specs are related to keyboard navigation?`
- `/openspec-ask restore-tab-badge-count 這個 change 的設計是什麼？`
- `/openspec-ask 你好`
- `/openspec-ask` (no question — infer from conversation context)
